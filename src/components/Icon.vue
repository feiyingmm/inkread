...
const ICONS: Record<string, IconDef> = {
  ...
  // 图钉:边缘悬浮出来的文库/大纲用它把浮层转成常驻展开
  pin: {
    paths: [
      'M12 17v5',
      'M9 10.8a2 2 0 0 1-1.1 1.8l-1.8.9A2 2 0 0 0 5 15.3V16a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-.7a2 2 0 0 0-1.1-1.8l-1.8-.9A2 2 0 0 1 15 10.8V7a1 1 0 0 1 1-1 2 2 0 0 0 0-4H8a2 2 0 0 0 0 4 1 1 0 0 1 1 1z',
    ],
  },
  ...
  /** 复制(两张叠起来的纸) */
  copy: {
    paths: ['M9 9h10a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2V11a2 2 0 0 1 2-2z', 'M5 15H4a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v1'],
  },
  /** 在文件管理器中显示(打开的文件夹) */
  'folder-open': {
    paths: ['M3 7a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v1', 'M2.6 19.4L4.7 12a1 1 0 0 1 .96-.7h15.7a1 1 0 0 1 .96 1.3l-2.1 6.8a1 1 0 0 1-.96.7H3.56a1 1 0 0 1-.96-1.3z'],
  },
  /** 权限/安全(盾牌) */
  shield: {
